...
class LifeLone_MNIST(object):
    ...
    def test(self):
        with tf.Session() as sess:
            ...
            self.saver.restore(sess, 'models/TeacherStudent_MNIST_TO_Fashion_WithoutClassLoss')
    ...
    def train(self):
        ...
        with tf.Session() as sess:
            ...
            f = open("results/MnistToFashion_mnist_WithoutClassLoss.txt", "w", encoding="utf-8")
            ...
            f = open("results/MnistToFashion_Fashion_WithoutClassLoss.txt", "w", encoding="utf-8")
            for i in range(np.shape(lossArr1)[0]):
                f.writelines(lossArr1[i])
                f.writelines('\n')
            f.flush()
            ...
            self.saver.save(self.sess, "models/TeacherStudent_MNIST_TO_Fashion_WithoutClassLoss")
