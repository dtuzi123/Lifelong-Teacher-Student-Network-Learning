...
class LifeLone_MNIST(object):
    ...
    def train(self):
        ...
        with tf.Session() as sess:
            ...
            f = open("results/MnistToFashion_BeginmnistAccuracy.txt", "w", encoding="utf-8")
            ...
            f.close()
            '''
            #self.saver.save(self.sess, "models/TeacherStudent_MNIST_TO_Fashion_invariant")
