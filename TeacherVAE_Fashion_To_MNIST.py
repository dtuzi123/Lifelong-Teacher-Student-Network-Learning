...
class LifeLone_MNIST(object):
    ...
    def test(self):
        with tf.Session() as sess:
            ...
            self.saver.restore(sess, 'models/TeacherVAE_Fashion_TO_MNIST2')
    ...
    def train(self):
        ...
        with tf.Session() as sess:
            ...
            self.saver.restore(sess, 'models/TeacherVAE_Fashion_TO_MNIST')
            ...
            f.close()
            '''
            self.saver.save(self.sess, "models/TeacherVAE_Fashion_TO_MNIST2")
