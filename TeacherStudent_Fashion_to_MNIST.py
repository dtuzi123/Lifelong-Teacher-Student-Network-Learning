...
class LifeLone_MNIST(object):
    ...
    def test(self):
        with tf.Session() as sess:
            ...
            self.saver.restore(sess, 'models/TeacherStudent_Fashion_TO_MNIST2')
    ...
    def train(self):
        ...
        with tf.Session() as sess:
            ...
            self.saver.restore(sess, 'models/TeacherStudent_Fashion_TO_MNIST')
            ...
            # define combination of old and new datasets
            # second state
            dataX = np.concatenate((self.mnist_train_x, oldX), axis=0)
            dataY = np.concatenate((self.mnist_train_y, oldY), axis=0)
            dataLabels = np.concatenate((self.mnist_label,oldLabels))
            labelsY = dataLabels
            ...
            f.close()
            '''
            self.saver.save(self.sess, "models/TeacherStudent_Fashion_TO_MNIST2")
