...
class LifeLone_MNIST(object):
    ...
    def test(self):
        with tf.Session() as sess:
            ...
            outputs1, outputs2,ganoutput = self.sess.run(
                [self.output1, self.output2,self.GAN_output],
            ...
            ims("results/" + "CelebaToChairs_short_gan" + str(0) + ".png", merge2(ganoutput[:10], [2, 5]))
    ...
    def train(self):
        ...
        with tf.Session() as sess:
            ...
            #self.saver.restore(sess, 'E:/Third_Experiment/Multiple_GAN_codes/models/TeacherStudent_Celeba_TO_Others')
            #self.saver.restore(sess, 'E:/Third_Experiment/models/TeacherStudent_Celeba_TO_Others2')
            ...
            for epoch in range(start_epoch, self.epoch):
                ...
                self.saver.save(self.sess, "models/TeacherStudent_Celeba_TO_Others2")
