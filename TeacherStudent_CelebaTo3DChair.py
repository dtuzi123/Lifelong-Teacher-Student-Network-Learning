...
class LifeLone_MNIST(object):
    ...
    def test(self):
        with tf.Session() as sess:
            ...
            self.saver.restore(sess, 'models/TeacherStudent_Celeba_TO_3DChair')
    ...
    def train(self):
        ...
        with tf.Session() as sess:
            ...
            for taskIndex in range(2):
                ...
                for epoch in range(start_epoch, self.epoch):
                    ...
                    for idx in range(start_batch_id, self.num_batches*myindex):
                        ...
                        if isFirstStage:
                            ...
                            batch_y = np.zeros((batch_size,self.len_discrete_code))
                            batch_images = celeba_data_files[idx * 32:(idx + 1) * 32]
                            batch = [get_image2(batch_file, 300, is_crop=True, resize_w=image_size, is_grayscale=0) \
                ...
                self.saver.save(self.sess, "models/TeacherStudent_Celeba_TO_3DChair")
